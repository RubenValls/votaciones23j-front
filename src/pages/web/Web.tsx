                ...
                <Box mt="10px">
                  <List spacing="15px" textAlign="start">
                    <ListItem>
                      ...
                      El objetivo de la web es poner en práctica conocimientos
                      tecnológicos relacionados con Front y Back End.
                    </ListItem>
                    <ListItem>
                      <ListIcon as={FaRegEye} color="orange" />
                      La finalidad de la web es observar la intención de voto de
                      la sociedad desde un punto de vista objetivo.
                    </ListItem>
                    <ListItem>
                      <ListIcon as={VscGistSecret} color="orange" />
                      Cualquier tipo de información aportada permanecerá privada
                      y jamás será compartida a terceros.
                    </ListItem>
                    <ListItem>
                      <ListIcon as={BiStats} color="orange" />
                      Los partidos corresponden a aquellos con más % de votos en
                      las pasadas elecciones generales del 2019.
                    </ListItem>
                    <ListItem>
                      <ListIcon as={BiMessageAltDots} color="orange" />
                      Para cualquier propuesta de mejora, al final de esta
                      página se encuentran los datos de contacto.
                    </ListItem>
                  </List>
                </Box>
              </Box>
                  ...
                  <Wrap spacing="30px" justify="center" p={10}>
                    <WrapItem>
                      <Center h="auto">
                        <Image
                          src={
                            "https://media.licdn.com/dms/image/C5603AQG8QeLH0sr4CQ/profile-displayphoto-shrink_800_800/0/1579774418282?e=2147483647&v=beta&t=TMcTbevd-HG6iEHqQHv1LCdjQdG0SO0tg4elpJ0D7W0"
                          }
                          alt="ruben-valls"
                          maxW="300px"
                          borderRadius="full"
                    ...
                    <WrapItem>
                      <Center>
                        <Stack mt="6" spacing="3">
                          ...
                          <Divider />
                          <Text>Desarrollador de Aplicaciones Web.</Text>
                          <Heading size="sm" mt="10px">
                            Contacto:
                          </Heading>
                          <Center>
                            <Link
                              href="https://www.linkedin.com/in/rubenvallsaparici/"
                              isExternal
                            >
                              <Button
                                colorScheme="orange"
                            ...
                            <Tooltip label="r.vallsaparici@gmail.com">
                              <Link
                                href="mailto:r.vallsaparici@gmail.com"
                                isExternal
                              >
                                <Button
                                  colorScheme="orange"
                          ...
                          <Center>
                            <Link
                              href="https://github.com/RubenValls/votaciones23j-front"
                              isExternal
                            >
                              <Button
                                colorScheme="orange"
